...
public class VegetarianFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_vegetarian, container, false);
        ...
        listofmm=dbH.GetAllVegetarianMeals();

        mealRecyclerView = (RecyclerView)view.findViewById(R.id.vegetarian_meal_recycler_view_id);
