...
public class BaseMealActivity extends BaseAppClass {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_base_meal);
        ...
        mAddToOrderList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Toast.makeText(BaseMealActivity.this, "Go back now", Toast.LENGTH_SHORT).show();
            }
        });
